...
# create background
bg = ui.PhotoImage(file='D:\Python projects\KanagawaWatchface.png')
...
# values are the length for each hand
seconds_hand_len = 160
minutes_hand_len = 145
hours_hand_len = 100

# seconds hand
seconds_hand = canvas.create_line(200, 200, 200 + seconds_hand_len, 200 + seconds_hand_len, width=1.5, fill='red')
# minutes hand
minutes_hand = canvas.create_line(200, 200, 200 + minutes_hand_len, 200 + minutes_hand_len, width=2.5, fill='white')
# hours hand
hours_hand = canvas.create_line(200, 200, 200 + hours_hand_len, 200 + hours_hand_len, width=5, fill='cyan')
